...
module.exports = {
  ...
  output: {
    ...
    filename: process.env.NODE_EVN !== "production" ? 'js/[hash].bundle.js' : 'js/[chunkhash].bundle.js',
    chunkFilename: 'js/[name].chunk.js',
    publicPath: '',//表示资源的发布地址
  },
  module: {
    rules: [{
      test: /\.(css|scss)$/,
      ...
      use: [{
        ...
        options: {
          ...
          name: '[name].[hash:8].[ext]',//images:图片打包的文件夹；
          outputPath: 'images/'
  ...
  plugins: [
    ...
    //   template: path.resolve(__dirname, './public/index1.html'),//模板文件路径
    //   inject: true,//插入位置
    //   minify: true,//压缩代码
    // }),
    //清除dist文件
